...
function OverviewTab({ resource: wh }: ResourceContext<MutatingWebhookResource>) {
...
export default function MutatingWebhookDetail() {
  return (
    <GenericResourceDetail<MutatingWebhookResource>
      resourceType="mutatingwebhookconfigurations"
      kind="MutatingWebhookConfiguration"
      pluralLabel="Mutating Webhooks"
      listPath="/mutatingwebhooks"
