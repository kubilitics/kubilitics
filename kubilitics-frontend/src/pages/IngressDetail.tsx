...
import { Globe, Lock, ExternalLink, Activity, Shield, Route, Server, Network } from 'lucide-react';
...
function ControllerTab() {
  return (
    <SectionCard title="Controller status" icon={Globe}>
      <p className="text-muted-foreground text-sm">Placeholder for ingress controller status.</p>
    </SectionCard>
  );
}
...
export default function IngressDetail() {
  ...
  const customTabs: CustomTab[] = [
    ...
    { id: 'controller', label: 'Controller Status', render: () => <ControllerTab /> },
