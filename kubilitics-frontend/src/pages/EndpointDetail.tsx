...
function HealthTab() {
  return (
    <SectionCard title="Health monitoring" icon={Activity}>
      <p className="text-muted-foreground text-sm">Placeholder for health check results.</p>
    </SectionCard>
  );
}
...
export default function EndpointDetail() {
  ...
  const customTabs: CustomTab[] = [
    ...
    { id: 'health', label: 'Health Monitoring', render: () => <HealthTab /> },
