...
const modes: {
...
}[] = [
  {
    ...
    activeBg: "bg-gradient-to-r from-emerald-50 to-emerald-100/60 dark:from-emerald-950/40 dark:to-emerald-900/30",
    activeText: "text-emerald-700 dark:text-emerald-300",
    activeBorder: "border-emerald-200 dark:border-emerald-800 ring-1 ring-emerald-100 dark:ring-emerald-900",
  ...
  },
  {
    ...
    activeBg: "bg-gradient-to-r from-blue-50 to-blue-100/60 dark:from-blue-950/40 dark:to-blue-900/30",
    activeText: "text-blue-700 dark:text-blue-300",
    activeBorder: "border-blue-200 dark:border-blue-800 ring-1 ring-blue-100 dark:ring-blue-900",
  ...
  },
  {
    ...
    activeBg: "bg-gradient-to-r from-pink-50 to-pink-100/60 dark:from-pink-950/40 dark:to-pink-900/30",
    activeText: "text-pink-700 dark:text-pink-300",
    activeBorder: "border-pink-200 dark:border-pink-800 ring-1 ring-pink-100 dark:ring-pink-900",
  ...
  },
  {
    ...
    activeBg: "bg-gradient-to-r from-violet-50 to-violet-100/60 dark:from-violet-950/40 dark:to-violet-900/30",
    activeText: "text-violet-700 dark:text-violet-300",
    activeBorder: "border-violet-200 dark:border-violet-800 ring-1 ring-violet-100 dark:ring-violet-900",
